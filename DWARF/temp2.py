...
class Player(pygame.sprite.Sprite):
	def __init__(self,pos, choice, group):
		...
		self.speed = 4
		if choice == 1:
			self.image = all_animations[2][0][0]
...
class CameraGroup(pygame.sprite.Group):
	...
	def __init__(self):
		...
		# limit
		self.limit = pygame.Rect(200,100,self.ground_surf.get_width(), self.ground_surf.get_height())
		self.limit_surf = pygame.Surface((self.ground_surf.get_width(), self.ground_surf.get_height()))
	...
	def center_target_camera(self,player1, player2):
		center = (np.array(player1.rect.center) + np.array(player2.rect.center)) / 2
		center = tuple(center)
		players_rect = pygame.Rect((center), (20,20))
		if players_rect.colliderect(self.limit):
			self.offset = center - pygame.math.Vector2(self.half_w, self.half_h)
...
all_animations = store_animations([skeleton_dico_v1],[minotaur_dico_v2,dwarf_dico_v2, indiana_jones_dico_v2, adventurer_dico_v2, bat_dico_v2, halo_dico_v2,gladiator_dico_v2, demon_dico_v2, cyclop_dico_v2],[hobbit_dico_v3])
