...
class HUD:
    ...
    def charge_projectile(self):
        self.charge = pygame.Surface((coeff*19,coeff*16*(1-self.player.shoot_timer/self.player.max_shoot_timer)), pygame.SRCALPHA)
        self.charge.fill((255, 255, 255))
        self.charge.set_alpha(150)
